...
class RiskProfileBuilder:
    ...
    def with_vehicle_product(self):
        self.risk_score.products['vehicle'] = VehicleProduct()
    ...
    def with_home_product(self):
        self.risk_score.products['home'] = HomeProduct()
        self.risk_profile = RiskProfile(
            risk_score=self.risk_score
        )
    ...
    def with_life_product(self):
        self.risk_score.products['life'] = LifeProduct()
        self.risk_profile = RiskProfile(
            risk_score=self.risk_score
        )
    ...
    def with_disability_product(self):
        self.risk_score.products['disability'] = DisabilityProduct()
        self.risk_profile = RiskProfile(
            risk_score=self.risk_score
        )
